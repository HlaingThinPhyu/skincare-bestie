...
export default function Home() {
  ...
  const [dataSource, setDataSource] = useState<"live" | "mock" | "cached" | undefined>(undefined);
  ...
  async function handleSubmit(filters: UserFilters) {
    ...
    try {
      ...
      const payload = data as RoutineResponse & {
  ...
  return (
    <main className="min-h-screen px-4 py-12">
      ...
      <div className="relative z-10 max-w-3xl mx-auto space-y-10">
        ...
        {routine ? (
          <>
            <ResultsDashboard routine={routine} filters={submittedFilters} dataSource={dataSource} onReset={() => { setRoutine(null); setSubmittedFilters(null); setDataSource(undefined); }} />
